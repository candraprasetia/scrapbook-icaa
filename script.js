document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "....." },
        { time: 3, text: "kamu adalah bukti" },
        { time: 7, text: "dari cantiknya paras dan hati" },
        { time: 11, text: "kau jadi harmoni saat ku bernyanyi" },
        { time: 16, text: "tentang terang dan gelapnya hidup ini" },
        { time: 21, text: " kaulah bentuk terindah" },
        { time: 25, text: "dari baiknya tuhan padaku" },
        { time: 30, text: "waktu tak mengusaikan cantikmu" },
        { time: 34, text: "kau wanita terhebat bagiku" },
        { time: 39, text: "tolong kamu camkan itu" },
        { time: 44, text: "....." },
    ];
